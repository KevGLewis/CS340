...
var serverAddressOne = 'flip1.engr.oregonstate.edu:2333/bridge';
...
function addItem(dataIn){
        ...
        req.open('GET', serverAddressOne + '?addItem=true&nbi_id='+ dataIn[0] + '&type=' + dataIn[1] + '&length=' + dataIn[2] + '&spans=' + dataIn[3] + '&zipcode=' + dataIn[4], true);
