...
var serverAddressOne = serverAddress + '/employee';
...
function addItem(dataIn){
        ...
        req.open('GET', serverAddress + '?addItem=true&employee_id='+ dataIn[0] + '&first_name=' + dataIn[1] + '&last_name=' + dataIn[2] + '&rate=' + dataIn[3] + '&office=' + dataIn[4], true);
