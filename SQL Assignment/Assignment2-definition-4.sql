...
CREATE TABLE client (
    ...
    dob DATE,
    PRIMARY KEY(id),
    CONSTRAINT fl_client UNIQUE (first_name, last_name)
) ENGINE=InnoDB
...
INSERT INTO client (first_name, last_name, dob) VALUES ('Sara', 'Smith', '1970-2-1'), ('David', 'Atkins', '1979-18-11'), ('Daniel', 'Jensen', '1985-2-3')
...
INSERT INTO employee (first_name, last_name, dob, date_joined) VALUES ('Adam', 'Lowd', '1975-2-1', '2009-1-1'), ('Michael', 'Fern', '1980-18-10', '2013-5-6'), ('Deena', 'Young', '1984-21-3', '2013-10-11')
...
INSERT INTO project (cid, name, notes) VALUES ((SELECT id FROM client WHERE first_name = 'Sara' AND last_name = 'Smith'), 'Diamond', 'Should be done by Jan 2017'), ((SELECT id FROM client WHERE first_name = 'David' AND last_name = 'Atkins'), 'Eclipse', NULL), ((SELECT id FROM client WHERE first_name = 'Daniel' AND last_name = 'Jensen'), 'Moon', NULL)
...
INSERT INTO works_on (eid, pid, start_date) VALUES ((SELECT id FROM employee WHERE first_name = 'Adam' AND last_name = 'Lowd'), (SELECT id FROM project WHERE name = 'Diamond'), '2012-1-1'), 
((SELECT id FROM employee WHERE first_name = 'Michael' AND last_name = 'Fern'), (SELECT id FROM project WHERE name = 'Eclipse'), '2013-8-8'),
((SELECT id FROM employee WHERE first_name = 'Michael' AND last_name = 'Fern'), (SELECT id FROM project WHERE name = 'Moon'), '2014-11-9')
