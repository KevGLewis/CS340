...
function addItem(dataIn){
        ...
        req.open('GET', serverAddress + "/" + extension + '?addItem=true&type='+ dataIn[0] + '&budget=' + dataIn[1] + '&pcomp=' + dataIn[2] + '&bridge=' + dataIn[3] + '&loa=' + dataIn[4], true);
